 ...
 ?>
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Công cụ tác giả</span>
        <h3 class="page-title">Bài báo của tôi</h3>
      </div>
    </div>
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item">
          <a class="nav-link <?= ($f=="all" || $f=="")? "active":""?>" href="?cn=my_article&f=all">Tất cả</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= $f=="unreviewed"? "active":""?>" href="?cn=my_article&f=unreviewed">Đợi xét duyệt</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= $f=="published"? "active":""?>" href="?cn=my_article&f=published">Đã xuất bản</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= $f=="draft"? "active":""?>" href="?cn=my_article&f=draft">Nháp</a>
        </li>
    </ul>
    <div class="row">
      <div class="col-12">
